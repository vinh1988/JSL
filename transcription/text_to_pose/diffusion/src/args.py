...
# Model Arguments
parser.add_argument('--noise_epsilon', type=float, default=1e-2, help='noise epsilon')
parser.add_argument('--seq_len_loss_weight', type=float, default=2e-5, help='sequence length weight in loss')
parser.add_argument('--smoothness_loss_weight', type=float, default=1e-3, help='smootheness weight in loss')
...
parser.add_argument('--encoder_heads', type=int, default=8, help='number of heads for the encoder')
